...
<header class="navbar">
    <div class="nav-container">
        ...
        <nav class="nav-main">
            <ul class="nav-links">
                <li><a href="index (1).php" class="<?php if ($current_page == 'index (1).php') echo 'active'; ?>">Home</a></li>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="how-to-apply.php" class="<?php if ($current_page == 'apply.php') echo 'active'; ?>">How to Apply</a></li>
                    </ul>
                </li>
