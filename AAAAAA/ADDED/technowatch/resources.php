...
<head>
    ...
    <script src="assets (1)\js (1)\resources.js" defer></script> <script src="https://kit.fontawesome.com/f6afcc28f7.js" crossorigin="anonymous"></script>
</head>
<body>

    <?php include 'header.php'; ?>

    <section class="resources-hero-section" style="background-image: url('assets (1)/imgs (1)/bg.png');">
            ...
            <div class="hub-category-block">
                ...
                <div class="preview-grid">
                    ...
                    <div class="timeline-item">
                        <div class="timeline-image">
                            <img src="assets (1)\imgs (1)\arduino.png" alt="IoT Workshop">
                        </div>
                        <div class="timeline-content">
            ...
            <div class="hub-category-block">
                ...
                <div class="projects-showcase-grid">
                    <div class="project-card">
                        <img src="assets (1)\imgs (1)\carousel_7 (1).jpg" alt="AI Chatbot Assistant" class="project-image">
                    ...
                    <div class="project-card">
                        <img src="assets (1)\imgs (1)\carousel_5 (1).jpg" alt="Smart Campus System" class="project-image">
                        <div class="project-info">
                    ...
                    <div class="project-card">
                        <img src="assets (1)\imgs (1)\carousel_4 (1).jpg" alt="E-Commerce Dashboard" class="project-image">
                        <div class="project-info">
