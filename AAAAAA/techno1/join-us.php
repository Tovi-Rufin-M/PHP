...
<head>
    ...
    <title>Join Us | Technowatch Club</title>
...
<nav class="breadcrumb">
    <div class="container">
        <span class="current">Join Us</span>
...
<section class="join-hero-gallery">
    <div class="hero-gallery-container">
        <div class="gallery-track">
            <img src="assets/imgs/carousel_1.jpg" alt="Technowatch Awareness 2025" class="gallery-item active">
            <img src="assets/imgs /carousel_2.jpg" alt="Mission & Vision Crafting" class="gallery-item">
            <img src="assets/imgs/carousel_3.jpg" alt="Club Awareness Campaign" class="gallery-item">
            <img src="assets/imgs/carousel_4.jpg" alt="IoT Home Automation Project" class="gallery-item">
            <img src="assets/imgs/carousel_5.jpg" alt="Technowatch College" class="gallery-item">
        </div>
    ...
    <div class="container">
        ...
        <div class="process-cards">
            <div class="process-card" onclick="window.location.href='how-to-apply.php'">
                ...
                <img src="assets/imgs/carousel_1.jpg" alt="Application Step">
            ...
            <div class="process-card" onclick="window.location.href='how-to-apply.php'">
                ...
                <img src="assets/imgs/carousel_2.jpg" alt="Interview Step">
                <h3>Quick Chat</h3>
            ...
            <div class="process-card" onclick="window.location.href='how-to-apply.php'">
                ...
                <img src="assets/imgs/carousel_3.jpg" alt="Welcome Step">
                <h3>Join Discord</h3>
